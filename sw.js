...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-4ebb7d","is-html-4ebb7d","is-jsdelivr-4ebb7d","is-gtm-4ebb7d","is-gravatar-4ebb7d","is-theme-4ebb7d","is-cdn-4ebb7d","is-json-4ebb7d"];
      return Promise.all(
        names
